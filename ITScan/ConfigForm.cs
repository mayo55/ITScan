...
namespace ITScan
{
    public partial class ConfigForm : Form
    {
        ...
        private void ConfigForm_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Rows.Add(Constant.MSG_ROTATE, Properties.Settings.Default.Rotate, Constant.ID_ROTATE);

            dataGridView1.CurrentCell = dataGridView1["value", 1];
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                switch (id)
                {
                    case Constant.ID_ROTATE:
                        int v;
                        int.TryParse(value, out v);
                        Properties.Settings.Default.Rotate = v;
                        break;
        ...
        private void dataGridView1_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
            ...
            {
                case Constant.ID_ROTATE:
                    if (!int.TryParse(formattedValue, out intValue) || (intValue != 0 && intValue != 90 && intValue != 180 && intValue != 270))
                    {
                        e.Cancel = true;
                    }
                    break;
        ...
        private void dataGridView1_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                case Constant.ID_ROTATE:
                    lblMessage.Text = "0:回転なし 90:右90度回転 180:180度回転 270:左90度回転";
                    break;
