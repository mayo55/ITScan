...
namespace ITScan
{
    public class MyDataSourceManager : IDisposable
    {
        /// <summary>
        ...
        public MyDataSource DataSource { get; private set; }

        public MyDataSourceManager(Identity applicationId, IWindowsMessageHook messageHook)
        {
            ...
            if (result == TwainResult.Success)
            {
                ...
                //right here
                DataSource = MyDataSource.GetDefault(ApplicationId, _messageHook);
            }
            else
            {
        ...
        {
            DataSource.Dispose();
            DataSource = MyDataSource.UserSelected(ApplicationId, _messageHook);
        }

        public void SelectSource(MyDataSource dataSource)
        {
            DataSource.Dispose();
        ...
        public static readonly Identity DefaultApplicationId = new Identity()
        {
            ...
            ProtocolMajor = MyTwainConstants.ProtocolMajor,
            ProtocolMinor = MyTwainConstants.ProtocolMinor,
